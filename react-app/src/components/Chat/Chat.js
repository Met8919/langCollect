...
import { definedSpeech, getDefinedSpeech, getSpeechLevel } from "../DefinedSpeech/definedSpeech";
...
export default function Chat() {
    ...
    useEffect(() => {
        ...
        if (Object.values(currentLanguage).length) {
            ...
            const definedSpeech = getDefinedSpeech(currentLanguage,knownWords)

            const messages = [...chat]
            messages[0] = {role: 'system', content: `Only speak in ${currentLanguage.name}. Also, ${definedSpeech}`}
